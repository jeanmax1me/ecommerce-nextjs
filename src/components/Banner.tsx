        ...
        <div className="w-full py-32 lg:py-0 lg:h-screen bg-slate-200 relative">
          ...
          <div className="lg:absolute lg:top-1/2 lg:left-2/3 transform lg:translate-x-1-2 lg:translate-y-1/2 flex flex-col items-center gap-5">
            <p className="text-xl uppercase">
              Discover top-quality products tailored just for you.
            </p>
            <p className="w-96 text-2xl text-center text-zinc-600">
              Explore the newest smartphones available on the market and turn
              your dream phone into a reality.
            </p>
